...
- **Weighted rare country scoring** with geopolitical awareness
...
### Weighted Country Scoring
Countries are dynamically classified using a sophisticated scoring system:
