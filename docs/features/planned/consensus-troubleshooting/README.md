...
**Design notes**:
- Flag thresholds shown as **columns by default** (not expandable) - each authority has unique values
...
```
┌─────────────────────────────────────────────────────────────────────────────────────────────────┐
│ 🏛️ Directory Authorities (9 discovered)                                                         │
├─────────────────────────────────────────────────────────────────────────────────────────────────┤
│ Consensus: ✅ FRESH │ 9/9 Voted │ Next: 15:00 UTC (23 min)                                     │
├─────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                                 │
│ ┌──────────┬────────┬──────┬───────┬─────────┬───────┬─────────┬─────────┬──────────┬─────────┐│
│ │Authority │ Status │ Vote │BW Auth│ Latency │Relays │Guard BW │ Stable  │Fast Speed│  WFU    ││
│ ├──────────┼────────┼──────┼───────┼─────────┼───────┼─────────┼─────────┼──────────┼─────────┤│
│ │ moria1 ↗ │ 🟢 OK  │  ✅  │  ✅   │  12ms   │ 8,247 │ 30 MB/s │ 19.6 d  │ 1.0 MB/s │  98%    ││
│ │ tor26 ↗  │ 🟢 OK  │  ✅  │  ✅   │  45ms   │ 8,201 │ 34 MB/s │ 19.8 d  │ 0.1 MB/s │  98%    ││
│ │ dizum ↗  │ 🟢 OK  │  ✅  │  ❌   │  38ms   │ 8,156 │ 10 MB/s │ 14.2 d  │ 0.1 MB/s │  98%    ││
│ │ gabelmoo↗│ 🟢 OK  │  ✅  │  ✅   │  52ms   │ 8,234 │ 35 MB/s │ 19.6 d  │ 0.1 MB/s │  98%    ││
│ │ bastet ↗ │ 🟢 OK  │  ✅  │  ✅   │  67ms   │ 8,189 │ 10 MB/s │ 14.3 d  │ 0.1 MB/s │  98%    ││
│ │dannenberg↗│🟢 OK  │  ✅  │  ❌   │  41ms   │ 8,178 │ 35 MB/s │ 19.2 d  │ 0.1 MB/s │  98%    ││
│ │ maatuska↗│ 🟢 OK  │  ✅  │  ✅   │  73ms   │ 8,167 │ 10 MB/s │ 19.3 d  │ 0.1 MB/s │  98%    ││
│ │ longclaw↗│ 🟢 OK  │  ✅  │  ✅   │  58ms   │ 8,145 │ 28 MB/s │ 18.5 d  │ 0.1 MB/s │  98%    ││
│ │faravahar↗│ 🟡 SLOW│  ✅  │  ✅   │  89ms   │ 8,123 │ 10 MB/s │ 19.1 d  │ 0.1 MB/s │  98%    ││
│ └──────────┴────────┴──────┴───────┴─────────┴───────┴─────────┴─────────┴──────────┴─────────┘│
│                                                                                                 │
│ ↗ = link to authority relay page                                                               │
...
**Threshold columns** (shown by default, per authority):
